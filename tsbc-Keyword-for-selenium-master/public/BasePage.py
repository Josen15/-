...
class Action:
	...
	#读取元素标签和元素唯一标识
	def locate(self, index, filepath="C:\\Users\\ling\\Desktop\\tsbc-Keyword-for-selenium-master\\Keyword-for-selenium-master\\dataEngine\\kuaixiu.xls", sheetname="element"):
		"""
		filepath: 文件路径
		sheetno：Sheet编号
		index: 元素编号
